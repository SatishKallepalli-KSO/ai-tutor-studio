...
export const TRACKS: Track[] = [
  {
    ...
    study_plan: [
      ...
      "Day 3–4: Drill 2 system designs (sync engine + API tradeoffs)",
      "Day 5: Cross-team influence + production incident narrative",
      "Day 6: Mock behavioral + deep dive on one production AI project",
      "Day 7: Timed answers out loud — score ≥4 on each topic before moving on",
    ],
  },
  {
    id: "em-interview",
    ...
    study_plan: [
      ...
      "Day 5: Delivery / prioritization conflict drills",
      "Day 6–7: Mock HM screen — speak every topic until score ≥4",
    ],
  },
  {
    id: 'java-to-ai',
