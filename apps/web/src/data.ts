...
export const QUESTIONS: TutorQuestion[] = [
  ...
  },
  {
    ...
    category: "Behavioral",
    prompt:
      "Tell me about a time you influenced a technical decision across teams without formal authority. What was the disagreement, how did you get alignment, and what shipped?",
    hints: [
  ...
  },
  {
    ...
    category: "System design",
    prompt:
      "You need a public API used by multiple product teams. How do you design versioning, auth, rate limits, and backwards compatibility so the platform can evolve without breaking clients?",
    hints: [
  ...
  },
  {
    ...
    category: "Production",
    prompt:
      "Walk me through a production incident you led or heavily influenced. How did you diagnose, mitigate, communicate, and prevent recurrence?",
    hints: [
  ...
  },
  {
    ...
    category: "Behavioral",
    prompt:
      "Describe how you raised the engineering bar for others — mentoring, design reviews, or standards — while still delivering your own Staff-level work.",
    hints: [
  ...
  },
  {
    ...
    prompt:
      "You're given a vague product request: 'make search smarter with AI.' How do you turn that into a Staff-level plan in the first two weeks — and what do you refuse to build yet?",
    hints: [
  ...
  },
  {
    ...
    prompt:
      "Your org has three overlapping data platforms and rising ops cost. How would you drive a multi-quarter technical strategy without a formal VP title?",
    hints: [
  ...
  },
  {
    ...
    category: "Hiring",
    prompt:
      "How do you run a hiring loop and keep the bar high when the team is under delivery pressure to 'just hire someone'?",
    hints: [
  ...
  },
  {
    ...
    category: "People",
    prompt:
      "Tell me about managing an underperformer. How did you diagnose, coach, document, and decide whether to exit or recover?",
    hints: [
  ...
  },
  {
    ...
    category: "Delivery",
    prompt:
      "How do you build a quarterly roadmap with product when engineering capacity is constrained and reliability work is non-negotiable?",
    hints: [
  ...
  },
  {
    ...
    prompt:
      "Your VP asks why a major initiative is late. How do you communicate status, options, and a recommendation in under three minutes?",
    hints: [
  ...
  },
  {
    ...
    category: "Org design",
    prompt:
      "A team of 18 reports to you and delivery is slowing. How do you rethink org shape, ownership boundaries, and manager span without creating chaos?",
    hints: [
  ...
  },
  {
    ...
    category: "Delivery",
    prompt:
      "A SEV is ongoing. How do you lead as EM — who does what, how do you protect the team, and what do you tell stakeholders?",
    hints: [
  ...
  },
  {
    ...
    category: "Evals",
    prompt:
      "How would you build an evaluation harness for an LLM feature before and after shipping — and what gates would stop a bad model deploy?",
    hints: [
  ...
  },
  {
    ...
    category: "Production",
    prompt:
      "An LLM feature is slow and expensive in production. How do you diagnose and improve latency and cost without wrecking answer quality?",
    hints: [
  ...
  },
  {
    ...
    category: 'Transition',
    prompt:
      'You are a Java engineer moving to Python. What skills transfer, what do you unlearn, and how do you stay production-safe without Java’s ceremony?',
    hints: [
  ...
  },
  {
    ...
    category: 'Language',
    prompt:
      'Map Java List and Map to Python. When do you use a comprehension, and what mutable-default pitfall must you avoid?',
    hints: [
  ...
  },
  {
    ...
    category: 'OOP',
    prompt:
      'How do Python dataclasses and Protocol compare to Java records/Lombok and interfaces? When do you still write a full class?',
    hints: [
  ...
  },
  {
    ...
    category: 'Tooling',
    prompt:
      'Describe the Python toolchain you would require on a team coming from Maven/JUnit: environments, types, tests, and CI checks.',
    hints: [
      'venv or poetry/uv',
      'mypy/pyright',
      'pytest',
  ...
  },
  {
    ...
    category: 'Concurrency',
    prompt:
      'Compare Java ExecutorService / CompletableFuture to Python asyncio. When is asyncio the wrong tool?',
    hints: [
  ...
  },
  {
    ...
    category: 'APIs',
    prompt:
      'Explain Spring Boot REST + Bean Validation as FastAPI + Pydantic. Where does business logic live, and what do you keep identical to Java service design?',
    hints: [
      'Pydantic ≈ @Valid DTOs',
