...
|------|-------------|---------|
| Overview | [/ai-tutor-studio/product/](https://satishkallepalli-kso.github.io/ai-tutor-studio/product/) | Value prop + plan matrix |
| Architecture | [architecture.html](https://satishkallepalli-kso.github.io/ai-tutor-studio/product/architecture.html) | System design diagrams |
...
# then http://localhost:4173/product/
```
